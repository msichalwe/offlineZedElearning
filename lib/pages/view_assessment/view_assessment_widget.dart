...
class ViewAssessmentWidget extends StatefulWidget {
  ...
  const ViewAssessmentWidget({super.key, this.assessmentId, this.syllabusId});
        ...
        body: SafeArea(
          ...
          child: SingleChildScrollView(
            child: FutureBuilder<List<SingleAssessmentRow >>(
              future: widget.assessmentId != null ? SQLiteManager.instance
                  .getAssessment(assessmentId: widget.assessmentId) : SQLiteManager.instance
                  .getQuiz(assessmentId: widget.syllabusId) ,
              builder:
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            await dbHelper.createGrade(
                                              userId: user,
                                              assessmentId:
                                                  widget.assessmentId ?? widget.syllabusId as int,
