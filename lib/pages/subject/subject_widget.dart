                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        FutureBuilder<List<GetSingleSyllabiRow>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final mainTopicsContainerGetSingleSyllabiRowList =
                                snapshot.data!;
                            return Container(
                                                            ...
                                                            child: Text(
                                                              '${valueOrDefault<String>(
                                                                mainTopicsContainerGetSingleSyllabiRowList
                                                                    .first
                                                                    .gradeName,
                                                                '${mainTopicsContainerGetSingleSyllabiRowList.first.gradeName}',
                                                              )} ${valueOrDefault<String>(
                                                                mainTopicsContainerGetSingleSyllabiRowList
                                                                    .first
                                                                    .subjectName,
                                                                    ...
                                                                    return Container(
                                                                      decoration: BoxDecoration(
                                                                          ...
                                                                          color: FlutterFlowTheme.of(context)
                                                                              .secondaryBackground,
                                                                          border:
                                                                              Border.all(color: Color(0xFFEFF1F2) as Color)),
                                                                      child:
                                                                          Column(
                                                                        mainAxisSize:
                                                                            MainAxisSize.max,
                                  ...
                                  Padding(
                                    padding:
                                        const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 7.0, 0.0, 8.0),
                                    child: Text(
                                      '${Provider.of<FFAppState>(context, listen: false).gradeName} Physics',
