...
class GradeDashboardWidget extends StatefulWidget {
  const GradeDashboardWidget({super.key, int? gradeId, String? gradeName})
      : gradeId = gradeId ?? 0,
        gradeName = gradeName ?? '';
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          'The ${Provider.of<FFAppState>(context, listen: false).gradeName} Dashboard',
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Wrap(
                                                            ...
                                                            children: [
                                                              Text(
                                                                'Lots of information for ${Provider.of<FFAppState>(context, listen: false).gradeName} students. The platform is full of different lessons excersies and examples, for many different books',
